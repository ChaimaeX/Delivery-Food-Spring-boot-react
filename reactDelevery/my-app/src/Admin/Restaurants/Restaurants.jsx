...
import { getRestaurants } from '../../component/State/admin/Action';
...
export default function Restaurants() {
  ...
  React.useEffect(() => {
    dispatch(getRestaurants({ jwt }));
  }, [dispatch]);

  const restaurants = admin.restaurants || [];
   const filteredRestaurants = restaurants.filter((restaurant) => {
    const matchesName = restaurant.name.toLowerCase().includes(searchQuery.toLowerCase());
    const matchesId = restaurant.id.toString().includes(searchQuery.toLowerCase());
    const matchesOwner = restaurant.owner.fullName.toLowerCase().includes(searchQuery.toLowerCase());
    return matchesName || matchesId || matchesOwner;
  });
