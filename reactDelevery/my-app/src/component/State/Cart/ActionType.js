 ...
 export const ADD_ITEM_TO_CART_REQUEST = 'GET_ALL_CART_ITEMS_REQUEST';
 export const ADD_ITEM_TO_CART_SUCCESS = 'GET_ALL_CART_ITEMS_SUCCESS';
 export const ADD_ITEM_TO_CART_FAILURE = 'GET_ALL_CART_ITEMS_FAILURE';
