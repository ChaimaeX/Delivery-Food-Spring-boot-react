...
export const UPDATE_MUNU_ITEMS_AVAILABILITY_REQUEST 
='UPDATE_MUNU_ITEMS_AVAILABILITY_REQUEST';
export const UPDATE_MUNU_ITEMS_AVAILABILITY_SUCCESS 
='UPDATE_MUNU_ITEMS_AVAILABILITY_SUCCESS';
export const UPDATE_MUNU_ITEMS_AVAILABILITY_FAILURE 
='UPDATE_MUNU_ITEMS_AVAILABILITY_FAILURE';

export const GET_TOP_MENU_ITEM_REQUEST
='GET_TOP_MENU_ITEM_REQUEST';
export const GET_TOP_MENU_ITEM_SUCCESS 
='GET_TOP_MENU_ITEM_SUCCESS';
export const GET_TOP_MENU_ITEM_FAILURE 
='GET_TOP_MENU_ITEM_FAILURE';

export const GET_ALL_MENU_ITEM_REQUEST
='GET_ALL_MENU_ITEM_REQUEST';
export const GET_ALL_MENU_ITEM_SUCCESS 
='GET_ALL_MENU_ITEM_SUCCESS';
export const GET_ALL_MENU_ITEM_FAILURE 
